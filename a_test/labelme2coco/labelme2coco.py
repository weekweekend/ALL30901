...
def main():
    ...
    # x_train, x_test, y_train, y_test = train_test_split(feature_files, label_files, test_size=0.001)
    x_train, x_test, y_train, y_test = train_test_split(feature_files, label_files, test_size=0.95)
...
## python labelme2coco.py --input_dir images_test --output_dir coco_test --labels labels.txt
## python labelme2coco.py --input_dir images_train --output_dir coco_train --labels labels.txt