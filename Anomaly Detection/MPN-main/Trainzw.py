...
parser.add_argument('--epochs', type=int, default=3001, help='number of epochs for training')
...
parser.add_argument('--exp_dir', type=str, default='log_dellllllll', help='directory of log')
...
train_folder = args.dataset_path+args.dataset_type+"/train_3_bs/frames"
