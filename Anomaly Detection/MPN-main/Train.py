...
parser.add_argument('--epochs', type=int, default=1001, help='number of epochs for training')
...
parser.add_argument('--exp_dir', type=str, default='log_2_small', help='directory of log')
parser.add_argument('--resume', type=str, default='exp/model_500.pth', help='file path of resume pth')
...
if args.gpus is None:
    ...
    os.environ["CUDA_VISIBLE_DEVICES"] = args.gpus[1]
