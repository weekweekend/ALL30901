...
def run():
    ...
    parser.add_argument('--max_iters', type=int, default=250001)
    parser.add_argument('--g_path', type=str, default="checkpoint/101.pth")
    parser.add_argument('--d_path', type=str, default="checkpoint/101.pth")
    ...
    if args.test:
        ...
        model.train(dataloader, args.model_save_path, args.finetune, args.max_iters)
