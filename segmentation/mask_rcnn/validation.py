...
def main(parser_data):
    ...
    det_metric = EvalCOCOMetric(val_dataset.coco, "bbox", "rest/det_results.json")
    seg_metric = EvalCOCOMetric(val_dataset.coco, "segm", "rest/seg_results.json")
    model.eval()
    with torch.no_grad():
    ...
    save_info(det_metric.coco_evaluator, category_index, "rest/det_record_mAP.txt")
    save_info(seg_metric.coco_evaluator, category_index, "rest/seg_record_mAP.txt")
...
if __name__ == "__main__":
    ...
    # 训练好的权重文件
    parser.add_argument('--weights-path', default='./save_weights/model_40.pth', type=str, help='training weights')
