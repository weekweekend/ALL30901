...
def create_model(num_classes, load_pretrain_weights=True):
    ...
    backbone = resnet50_fpn_backbone(pretrain_path="./pretrain/scnet50.pth", trainable_layers=3)
    ...
    if load_pretrain_weights:
        ...
        weights_dict = torch.load("./pretrain/maskrcnn_resnet50_fpn_coco.pth", map_location="cpu")
...
def main(args):
    ...
    det_results_file = f"rest/det_results{now}.txt"
    seg_results_file = f"rest/seg_results{now}.txt"
...
if __name__ == "__main__":
    ...
    # 训练数据集的根目录
    parser.add_argument('--data-path', default='data/coco76', help='dataset')
    # 检测目标类别数(不包含背景)
